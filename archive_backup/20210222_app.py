...
tips = pd.read_sql("SELECT * FROM property_sales_canberra_preprocessed100.mytable", dbConnection)
...
def update():
    ...
    if request.method == 'POST':
        ...
        # query = f"INSERT INTO mytable (price, parking, bathrooms, bedrooms, suburb, propertyType, quarters, seasons) \
        #     VALUES ({price_},{parking_},{bathrooms_},{bedrooms_},{suburb_},{propertyType_},{quarters_},{seasons_})"

        # query = f"""INSERT INTO mytable (
        #         price, 
        #         parking,
        #         bathrooms, 
        #         bedrooms, 
        ...
        # flash('You have inserted new data!', 'success')
